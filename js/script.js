...
// Напишіть метод calcTotalPrice(stoneName), який приймає назву каменю і розраховує та
// повертає загальну вартість каменів з таким ім'ям, ціною та кількістю з властивості stones.
...
console.table(shop2.stones);

console.log(
    'Перевикористання функції',
    chopShop.calcTotalPrice.call(shop2, 'Щебінь'),
);
console.log(
    'Перевикористання функції',
    chopShop.calcTotalPrice.call(shop2, 'Пісок'),
);
